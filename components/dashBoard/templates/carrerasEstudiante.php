...
<div class="alert alert-info fade in">
    <strong><i class="fa fa-info-circle fa-2x" aria-hidden="true"></i></strong> <span class="text-2x">Para poder continuar debe seleccionar una carrera haciendo clic sobre el nombre de la misma.</span>
</div>
<div class="panel">
